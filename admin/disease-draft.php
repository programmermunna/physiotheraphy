                                ...
                                <div class="input_area">
                                    <table class="table table-dark">
                                        ...
                                        <tbody>
                                            ...
                                            $totalEmpSQL = "SELECT * FROM disease WHERE status='Draft' ORDER BY id DESC";
                                            ...
                                            $empSQL = "SELECT * FROM disease WHERE status='Draft' ORDER BY id DESC LIMIT $startFrom, $showRecordPerPage";
